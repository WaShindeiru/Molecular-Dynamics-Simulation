...
#[test]
fn test_reset_world_no_missing_iterations() {
    ...
    for iteration_atoms in &world_dto.atoms {
...
#[test]
fn test_reset_world_with_thermostat() {
    let test_dir = "../test/test_reset_world_with_thermostat";
...
#[test]
fn test_save_files_completeness() {
    let test_dir = "../test/test_save_files_completeness";
