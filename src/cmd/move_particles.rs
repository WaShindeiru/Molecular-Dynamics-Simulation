...
pub struct MoveCommand {
  ...
  /// Displacement along the X axis in meters (SI).
  #[arg(short = 'x', long, default_value_t = 0.0)]
  pub x: f64,

  /// Displacement along the Y axis in meters (SI).
  #[arg(short = 'y', long, default_value_t = 0.0)]
  pub y: f64,

  /// Displacement along the Z axis in meters (SI).
...
pub fn move_particles_command(command: MoveCommand) -> io::Result<()> {
