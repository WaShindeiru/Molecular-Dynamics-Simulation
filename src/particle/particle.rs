...
impl Particle {
  ...
  pub fn set_potential_energy(&mut self, potential_energy_: f64) {
    match self {
      ...
      Particle::CustomPathAtom(custom_path_atom) => {
        custom_path_atom.set_potential_energy(potential_energy_)
      }
    }
  }
  ...
  pub fn set_potential_gravity_energy(&mut self, potential_gravity_energy: f64) {
    match self {
      ...
      Particle::CustomPathAtom(custom_path_atom) => {
        custom_path_atom.set_potential_gravity_energy(potential_gravity_energy)
      }
    }
  }
  ...
  pub fn set_acceleration(&mut self, acceleration_: Vector3<f64>) {
    match self {
      ...
      Particle::CustomPathAtom(custom_path_atom) => {
        custom_path_atom.set_acceleration(acceleration_)
      }
    }
  }
  ...
  pub fn set_thermostat_work(&mut self, thermostat_work: f64) {
    match self {
      ...
      Particle::CustomPathAtom(custom_path_atom) => {
        custom_path_atom.set_thermostat_work(thermostat_work)
      }
    }
  }
  ...
  pub fn custom_clone(&self) -> Particle {
    match self {
      ...
      Particle::CustomPathAtom(custom_path_atom) => {
        Particle::CustomPathAtom(custom_path_atom.clone())
      }
    }
  }
  ...
  pub fn reset_clone(&self) -> Particle {
    match self {
      ...
      Particle::CustomPathAtom(custom_path_atom) => {
        Particle::CustomPathAtom(custom_path_atom.reset_clone())
      }
    }
  }
}
